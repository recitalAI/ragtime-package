...
from ragtime.config import (
    RagtimeException,
    FOLDER_ANSWERS, FOLDER_FACTS, FOLDER_EVALS,
...
def run_pipeline(
    ...
    generator_table:dict[str, dict] = {
        'answers': {
            'generator': (lambda llms, retriever : AnsGenerator(llms = llms, retriever = retriever).generate ),
    ...
    for step in steps:
        ...
        output_folder = step_conf.get('output_folder', generator['default_output_folder'])
